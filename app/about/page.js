      ...
      <section style={{
        ...
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '0 2rem' }}>
          ...
          <p style={{
            ...
            insights in Australian employment data. Currently an Asset Data and Reporting
            Analyst at TAFE NSW.
          </p>
        </div>
      </section>
        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '0 2rem' }}>
          <div style={{
            ...
            <div style={{ fontSize: '1.125rem', marginBottom: '2rem' }}>
              ...
              <p style={{ marginBottom: '1.5rem' }}>
                Today, I&apos;m an Asset Data and Reporting Analyst at TAFE NSW, bringing together my customer
                service background, technical skills, and voracious appetite for learning. My academic foundation
                includes a BA in Media &amp; Communications with a minor in Music, and an MSc in Digital Media,
                while my data skills come from on-the-job experience and continuous learning through platforms
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 2rem' }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <ul style={{ color: '#a7f3d0', fontSize: '0.95rem', listStyle: 'none', padding: 0, lineHeight: 1.6 }}>
                <li style={{ marginBottom: '0.5rem' }}>✓ Python (Pandas, NumPy, Plotly)</li>
                <li style={{ marginBottom: '0.5rem' }}>✓ R (tidyverse, ggplot2, lubridate)</li>
                ...
                <li style={{ marginBottom: '0.5rem' }}>✓ Data visualisation and storytelling</li>
            ...
            <div style={{
              ...
              <ul style={{ color: '#a7f3d0', fontSize: '0.95rem', listStyle: 'none', padding: 0, lineHeight: 1.6 }}>
                ...
                <li style={{ marginBottom: '0.5rem' }}>✓ Pattern recognition and detail focus</li>
                <li style={{ marginBottom: '0.5rem' }}>✓ Compliance and statistical detection</li>
                <li style={{ marginBottom: '0.5rem' }}>✓ Workforce and employment analytics</li>
                <li style={{ marginBottom: '0.5rem' }}>✓ Data accuracy and quality assurance</li>
            ...
            <div style={{
              ...
              <ul style={{ color: '#a7f3d0', fontSize: '0.95rem', listStyle: 'none', padding: 0, lineHeight: 1.6 }}>
                ...
                <li style={{ marginBottom: '0.5rem' }}>✓ Training and knowledge transfer</li>
      ...
      <section style={{ padding: '4rem 0', background: '#0f766e' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '0 2rem' }}>
          <div style={{
            ...
            <h2 style={{ fontSize: '2rem', fontWeight: 'bold', marginBottom: '2rem', color: '#0f766e' }}>
              Beyond the Numbers
            </h2>
            ...
            <div style={{
              ...
              <p style={{
                ...
                I believe that behind every data point is a human story. Whether tracing the recovery
                of Australia&apos;s arts sector through COVID, or reconstructing what retail workers were
                actually owed under an award they may never have read, my focus is always on the
                <em> people</em> factor. Data isn&apos;t just numbers — it&apos;s a window into human experiences,
                challenges, and entitlements. That perspective, combined with my neurodivergent
                analytical strengths and customer service background, allows me to find insights
      ...
      <section style={{ padding: '4rem 0', background: '#115e59', textAlign: 'center' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '0 2rem' }}>
          ...
          <p style={{
            ...
            Whether you need workforce analytics, compliance insights, or someone who can find
...
export const metadata = {
  ...
  description: 'From 16 years at Apple to data analytics. Asset Data and Reporting Analyst at TAFE NSW. Neurodivergent problem-solver specialising in workforce and compliance analytics on the Central Coast, NSW.',
  keywords: 'data analyst, workforce analytics, compliance analytics, Apple career change, neurodivergent analyst, Central Coast NSW, TAFE NSW, R, Python, ggplot2',
  openGraph: {
    title: 'About | Jess Ferraro - Data Analyst',
    description: 'From Apple retail to data analytics — bringing customer focus and unique analytical perspective to Australian employment and compliance data.',
    type: 'website'
  }
}
